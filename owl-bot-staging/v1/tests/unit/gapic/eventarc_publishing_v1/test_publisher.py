...
from google.cloud.eventarc_publishing_v1.services.publisher import PublisherAsyncClient
from google.cloud.eventarc_publishing_v1.services.publisher import PublisherClient
from google.cloud.eventarc_publishing_v1.services.publisher import transports
...
def test_publisher_client_service_account_always_use_jwt(transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (PublisherAsyncClient, transports.PublisherGrpcAsyncIOTransport, "grpc_asyncio"),
])
@mock.patch.object(PublisherClient, "DEFAULT_ENDPOINT", modify_default_endpoint(PublisherClient))
@mock.patch.object(PublisherAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(PublisherAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (PublisherAsyncClient, transports.PublisherGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (PublisherClient, transports.PublisherGrpcTransport, "grpc", "false"),
    (PublisherAsyncClient, transports.PublisherGrpcAsyncIOTransport, "grpc_asyncio", "false"),
])
@mock.patch.object(PublisherClient, "DEFAULT_ENDPOINT", modify_default_endpoint(PublisherClient))
@mock.patch.object(PublisherAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(PublisherAsyncClient))
@mock.patch.dict(os.environ, {"GOOGLE_API_USE_MTLS_ENDPOINT": "auto"})
def test_publisher_client_mtls_env_auto(client_class, transport_class, transport_name, use_client_cert_env):
...
@pytest.mark.parametrize("client_class", [
    PublisherClient, PublisherAsyncClient
])
@mock.patch.object(PublisherClient, "DEFAULT_ENDPOINT", modify_default_endpoint(PublisherClient))
@mock.patch.object(PublisherAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(PublisherAsyncClient))
...
def test_publisher_client_client_options_scopes(client_class, transport_class, transport_name):
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    ...
    (PublisherAsyncClient, transports.PublisherGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
])
def test_publisher_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_publisher_client_client_options_from_dict():
    with mock.patch('google.cloud.eventarc_publishing_v1.services.publisher.transports.PublisherGrpcTransport.__init__') as grpc_transport:
...
def test_publisher_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
def test_publish_channel_connection_events(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
            type(client.transport.publish_channel_connection_events),
            '__call__') as call:
...
@pytest.mark.asyncio
async def test_publish_channel_connection_events_async(transport: str = 'grpc_asyncio', request_type=publisher.PublishChannelConnectionEventsRequest):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(publisher.PublishChannelConnectionEventsResponse(
        ))
...
def test_publish_events(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.publish_events),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
@pytest.mark.asyncio
async def test_publish_events_async(transport: str = 'grpc_asyncio', request_type=publisher.PublishEventsRequest):
    client = PublisherAsyncClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(publisher.PublishEventsResponse(
        ))
...
def test_publisher_base_transport():
    ...
    with mock.patch('google.cloud.eventarc_publishing_v1.services.publisher.transports.PublisherTransport.__init__') as Transport:
...
def test_publisher_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.eventarc_publishing_v1.services.publisher.transports.PublisherTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_publisher_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.eventarc_publishing_v1.services.publisher.transports.PublisherTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.PublisherTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize("transport_class", [transports.PublisherGrpcTransport, transports.PublisherGrpcAsyncIOTransport])
...
def test_publisher_host_no_port(transport_name):
    client = PublisherClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='eventarcpublishing.googleapis.com'),
...
def test_publisher_host_with_port(transport_name):
    client = PublisherClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='eventarcpublishing.googleapis.com:8000'),
        transport=transport_name,
    )
    assert client.transport._host == (
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.PublisherGrpcTransport, transports.PublisherGrpcAsyncIOTransport])
def test_publisher_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
