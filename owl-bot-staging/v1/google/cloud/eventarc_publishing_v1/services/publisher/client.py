...
class PublisherClient(metaclass=PublisherClientMeta):
    ...
    def publish_channel_connection_events(self,
            request: Optional[Union[publisher.PublishChannelConnectionEventsRequest, dict]] = None,
            *,
    ...
    def publish_events(self,
        ...
        # Create or coerce a protobuf request object.
        # Minor optimization to avoid making a copy if the user passes
        # in a publisher.PublishEventsRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, publisher.PublishEventsRequest):
            request = publisher.PublishEventsRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.publish_events]
