...
class PublisherTransport(abc.ABC):
    ...
    DEFAULT_HOST: str = 'eventarcpublishing.googleapis.com'
    def __init__(
            self, *,
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.publish_channel_connection_events: gapic_v1.method.wrap_method(
                self.publish_channel_connection_events,
                default_timeout=60.0,
                client_info=client_info,
            ),
            self.publish_events: gapic_v1.method.wrap_method(
                self.publish_events,
